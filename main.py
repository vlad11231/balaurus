...
# ==========================================
# 1. FORȚARE PROXY GLOBAL (WEBSHARE)
# ==========================================
# Asta forțează ORICE cerere din acest script să treacă prin proxy-ul tău
PROXY_URL = "http://lnigvxes:11agoe0f1dqv@64.137.96.74:6641"
...
# ==========================================
print("⏳ Se inițializează armamentul greu (Conexiune Polymarket)...")
try:
    # Clientul va lua automat proxy-ul din os.environ setat mai sus
...
def fetch_activity(addr):
    try:
        # Extragem datele balenei (folosește proxy-ul global)
        r = requests.get(API_ACTIVITY, params={"user": addr, "limit": 10}, headers=FAKE_HEADERS, timeout=10)
